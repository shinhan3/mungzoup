    ...
    <View style={styles.view}>
      ...
      <View style={[styles.walkingBox, styles.healthboxPosition]}>
        ...
        <View style={styles.title2}>
          ...
          <Pressable onPress={()=>{props.navigation.navigate('PLAY4');}}>
     ...
     <View>
      <Text style={[styles.profileTitle, styles.donationPosition]}>
        ...
        <Image
          ...
          <View style={{ marginLeft: 10 }}>
            <Pressable onPress={()=>{props.navigation.navigate('MyDaengUpdate');}}>
              <Image
            ...
            <View style={[styles.petinfotext, styles.timeChildLayout]}>
              <Text style={[styles.doginfo, styles.textLayout1]}>{`5세 - 여아`}</Text>
              <View style={[styles.timeChild, styles.timeChildLayout]} />
              <Text style={[styles.dogname, styles.text10Position]}>멍줍이</Text>
            </View>
          </View>
          <Image
      ...
      <Pressable style={[styles.walkbtn, styles.eventLayout2]} onPress={()=>{props.navigation.navigate('PLAY1');}}>
      ...
      <Pressable onPress={()=>{props.navigation.navigate('Frame');}}>
          ...
          <View style={[styles.event3, styles.event3Layout]}>
            <View style={styles.eventText3}>
              <Text style={styles.headerMenu}>
                <Text style={[styles.text16, styles.textTypo3]}>{`제휴 `}</Text>
                <Text style={[styles.text17, styles.mydogTypo]}>멍줍</Text>
                <Text
                  style={[styles.text16, styles.textTypo3]}
        ...
        <Pressable onPress={()=>{props.navigation.navigate('PLAYmainwonny');}}>
          ...
          <View style={styles.event2}>
            ...
            <View style={[styles.eventText2, styles.eventText2Position]}>
              <Text style={[styles.text21, styles.textPosition]}>
                <Text style={[styles.text17, styles.mydogTypo]}>멍줍 PLAY</Text>
                <Text>
            ...
            <View style={[styles.eventText1, styles.eventText1Position]}>
              <Text style={styles.textPosition}>
                ...
                <Text style={styles.textTypo3}>
                  <Text style={styles.textTypo4}>{`포인트가 모이면 기부가 `}</Text>
      ...
      <Pressable style={[styles.newprofilebtn, styles.newprofilebtnLayout]} onPress={()=>{props.navigation.navigate('MyDaenegRegister');}}>
