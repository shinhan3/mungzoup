  ...
  return (
    <View style={styles.view}>
      <View style={styles.main}>
        ...
        <Pressable style={styles.insertbtn} update-btn="수정">
          <View style={styles.backgroundbtn} />
          <Text style={[styles.textbtn, styles.textbtnFlexBox]}>수정</Text>
        </Pressable>
      </View>
      <View style={styles.header}>
        <View style={[styles.headerDiv, styles.divPosition]} />
        <Text style={[styles.headerTitle, styles.textbtnFlexBox]}>
          펫 프로필
        </Text>
        <Image
