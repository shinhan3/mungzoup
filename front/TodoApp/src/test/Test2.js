...
function Test2(props) {
  ...
  const deleteTest = e => {
    console.log(e);
    //axios delete
    axios.delete(`http://192.168.0.88:5000/delete.do/${e}`).then(res => {
  ...
  const updateTest = (seq, content) => {
    ...
    //axios put
    axios
      .put('http://192.168.0.88:5000/updateTest.do', {
        seqno: seq,
        content: content,
      })
      .then(res => {
  ...
  const insertTest = () => {
    ...
    //axios post
    axios
      .post('http://192.168.0.88:5000/insertTest.do', test)
      .then(res => {
        console.log(res.data);
        setTestList([...res.data]);
      })
  ...
  useEffect(() => {
    ...
    //axios get
    axios
      .get('http://192.168.0.88:5000/getTest.do')
      .then(res => {
        console.log(res.data);
        setTestList([...res.data]);
      })
      ...
      <View>
        <View style={styles.container}>
          ...
          <Button
            title="테스트"
            onPress={() => {
              axios.post('http://192.168.0.88:5000/test.do', null, {
                params: {
                  SPOT_NAME: 'test',
